    ...
    <main>
        ...
        <section class="world-class">
            <div>
                ...
                <p class="grey">ดำเนินงานด้วยมาตรฐานสากลGHPและHACCPโดยควบคุมระบบการผลิตระดับเดียวกับประเทศญี่ปุ่น พร้อมมอบบริการแบบ One-Stop Serviceที่สะอาดและปลอดภัยในทุกขั้นตอนการแปรรูป</p>
            </div>
            <img src="assets/images/certificate-world-class.png">
        </section>

        <section class="itthisak">
